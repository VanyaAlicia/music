...
module.exports = {
  name: "play",
  description: "Putar lagu favorit Anda",
  usage: "[song]",
  permissions: {
      ...
      if (SearchString.match(client.Lavasfy.spotifyPattern)) {
        ...
        if (Searched.loadType === "PLAYLIST_LOADED") {
          ...
          SongAddedEmbed.setAuthor(
            `Daftar putar ditambahkan ke antrean`,
          ...
          //SongAddedEmbed.addField("Playlist Durasi", `\`${prettyMilliseconds(Searched.tracks, { colonNotation: true })}\``, false)
          ...
          if (!player.playing && !player.paused && !player.queue.size)
            player.play();
          SongAddedEmbed.setAuthor(`Ditambahkan ke antrean`, client.botconfig.IconURL);
          ...
          //SongAddedEmbed.addField("Durasi", `\`${prettyMilliseconds(Searched.tracks[0].length, { colonNotation: true })}\``, true);
          ...
          return client.sendTime(
            message.channel,
            "**Tidak ditemukan kecocokan untuk - **" + SearchString
          );
        }
      } else {
        ...
        if (Searched.loadType === "NO_MATCHES")
          ...
          SongAddedEmbed.addField(
            "Playlist Durasi",
            `\`${prettyMilliseconds(Searched.playlist.Durasi, {
              colonNotation: true,
            })}\``,
            false
          );
          ...
          SongAddedEmbed.addField(
            "Durasi",
            `\`${prettyMilliseconds(Searched.tracks[0].Durasi, {
              colonNotation: true,
            })}\``,
            true
          );
      ...
      if (search.match(client.Lavasfy.spotifyPattern)) {
        ...
        switch (Searched.loadType) {
          ...
          case "SEARCH_RESULT":
            ...
            SongAdded.setAuthor(`Ditambahkan ke antrean`, client.botconfig.IconURL);
        ...
        try {
          ...
          return client.sendError(
            interaction,
            `Terjadi kesalahan saat mencari: ${err.message}`
          );
        }
        switch (res.loadType) {
          case "NO_MATCHES":
          ...
          case "TRACK_LOADED":
            ...
            SongAddedEmbed.addField(
              "Durasi",
              `\`${prettyMilliseconds(res.tracks[0].Durasi, {
                colonNotation: true,
              })}\``,
              true
            );
          ...
          case "PLAYLIST_LOADED":
            ...
            SongAdded.addField(
              "Playlist Durasi",
              `\`${prettyMilliseconds(res.playlist.Durasi, {
                colonNotation: true,
              })}\``,
              false
            );
          ...
          case "SEARCH_RESULT":
            ...
            if (!player.playing && !player.paused && !player.queue.length) {
              ...
              SongAddedEmbed.addField(
                "Durasi",
                `\`${prettyMilliseconds(track.Durasi, {
                  colonNotation: true,
                })}\``,
                true
              );
